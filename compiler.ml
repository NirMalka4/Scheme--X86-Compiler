...
let make_prologue consts_tbl fvars_tbl =
  ...
  [
    ...
    "cons", "_cons"; "car", "_car"; "cdr", "_cdr"; "set-car!", "_set_car"; "set-cdr!", "_set_cdr"; "apply", "_apply";
  ] in
  let make_primitive_closure (prim, label) =
    ...
    "MAKE_CLOSURE(rax, SOB_NIL_ADDRESS, " ^ label  ^ ")\n" ^
      "mov qword [fvar_tbl + (" ^  (string_of_int (List.assoc prim fvars_tbl)) ^ " * WORD_SIZE)" ^"], rax" in
